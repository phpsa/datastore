                    ...
                    <table class="table">
                        ...
                        @foreach($content as $contentItem)
                            <tr>
								...
								<td>
									@if($contentItem->page)
									<a href="{{ route('frontend.ams.page.id.slug', ['slug' => $contentItem->page->slug, 'id' => $contentItem->id]) }}" target="_blank">{{ route('frontend.ams.page.id.slug', ['slug' => $contentItem->page->slug, 'id' => $contentItem->id]) }}</a>
									@endif
								</td>
								@endif
								<td>
